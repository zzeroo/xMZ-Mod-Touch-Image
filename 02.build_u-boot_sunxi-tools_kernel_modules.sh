...
install_dependencies(){
  ...
  run "sudo systemd-nspawn -D ${CONTAINER_DIR}/${DISTRIBUTION}_armhf-development /bin/bash -c \"apt-get install -y build-essential pkg-config git wget fakeroot zlib1g-dev libncurses5-dev u-boot-tools pciutils usbutils\""
}
